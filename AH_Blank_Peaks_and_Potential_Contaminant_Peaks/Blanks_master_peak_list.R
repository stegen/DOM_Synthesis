...
###flag  each MF whether it is also in known contaminant on list provided 
##by Oliver Lechtenfeld. 
##contaminant list provided in github 



##quick evaluations of  
hist(Blanks_Peak_List$Frequency, xlab ="Number of Blanks")
summary(Blanks_Peak_List$Frequency)
plot(Blanks_Peak_List$Frequency~Blanks_Peak_List$Theor_MZ)
